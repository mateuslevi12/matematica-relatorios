...
import { getBaseAlunos, getBaseDengue, getBaseOnibus, getRelatorio1, getRelatorio10, getRelatorio2, getRelatorio3, getRelatorio4, getRelatorio5, getRelatorio6, getRelatorio7, getRelatorio8, getRelatorio9 } from "@/data/relatorios";
