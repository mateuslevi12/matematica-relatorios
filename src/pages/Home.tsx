        ...
        <div className="p-4 flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className={`gap-2 ${styles.relatorios}`}>
                    <CardComponent titulo='Relatorio 1 - Educação' descricao='Cidadãos que frequentam a escola menos os que tiveram dengue.' icon={<IoBookOutline />} quantidade={236} />
                    <CardComponent titulo='Relatorio 2 - Saúde' descricao='Cidadãos que frequentaram o posto de saúde menos os que não utilizam onibus.' icon={<GiHealthNormal />} quantidade={189} />
                    <CardComponent titulo='Relatorio 3 - Mobilidade' descricao='Cidadãos que utilizaram o transporte público e não tiveram dengue.' icon={<IoBus />} quantidade={182} />
                    ...
                    <CardComponent titulo='Relatorio 8' descricao='Cidadãos que frequentaram o posto de saúde, mas não utilizaram transporte público.' icon={<GiHealthNormal />} quantidade={189} />
                    <CardComponent titulo='Relatorio 9' descricao='Cidadãos que frequentaram o posto de saúde, mas não frequentaram a escola.' icon={<IoBus />} quantidade={175} />
                    <CardComponent titulo='Relatorio 10' descricao='Cidadãos que frequentaram o posto de saúde, mas não frequentaram a escola, nem utilizaram transporte público.' icon={<IoBus />} quantidade={164} />
                </div>
            </div>
        </div>
    )
